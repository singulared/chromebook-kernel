...
#ifndef __SND_SOC_SAMSUNG_HDMI_AUDIO_H
#define __SND_SOC_SAMSUNG_HDMI_AUDIO_H

#define BYTE0_CLR			(~((u32)0xFF))
...
#define HDMI_MPG_DATA(n)		HDMI_CORE_BASE(0x0920 + 4 * (n-1))
...
#define HDMI_I2S_CON_2_CLR		(BYTE0_CLR)
...
#define HDMI_I2S_MUX_CON_CLR		(BYTE0_CLR)
...
#define HDMI_I2S_CH_ST_0_CLR		(BYTE0_CLR)
...
#define HDMI_I2S_MUX_CH_CLR		(~(u32)HDMI_I2S_CH_ALL_EN)
