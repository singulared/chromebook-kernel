...
enum exynos5420_clks {
	...
	pclk_i2s2, pclk_pcm1, pclk_pcm2, pwm,
...
struct samsung_mux_clock exynos5420_mux_clks[] __initdata = {
	...
	MUX(none, "mout_user_aclk66_peric", mout_user_aclk66_peric_p,
			SRC_TOP4, 8, 1),
	MUX(none, "mout_aclk66_psgen", mout_user_aclk66_peric_p,
			SRC_TOP5, 4, 1),
...
struct samsung_gate_clock exynos5420_gate_clks[] __initdata = {
	...
	/* uart */
	GATE(pclk_uart0, "pclk_uart0", "aclk66_peric",
			GATE_BUS_PERIC, 4, CLK_IGNORE_UNUSED, 0),
	GATE(pclk_uart1, "pclk_uart1", "aclk66_peric",
			GATE_BUS_PERIC, 5, CLK_IGNORE_UNUSED, 0),
	GATE(pclk_uart2, "pclk_uart2", "aclk66_peric",
			GATE_BUS_PERIC, 6, CLK_IGNORE_UNUSED, 0),
	GATE(pclk_uart3, "pclk_uart3", "aclk66_peric",
			GATE_BUS_PERIC, 7, CLK_IGNORE_UNUSED, 0),
	GATE(sclk_uart0, "sclk_uart0", "dout_uart0", GATE_TOP_SCLK_PERIC, 0,
			CLK_IGNORE_UNUSED, 0),
	GATE(sclk_uart1, "sclk_uart1", "dout_uart1", GATE_TOP_SCLK_PERIC, 1,
			CLK_IGNORE_UNUSED, 0),
	GATE(sclk_uart2, "sclk_uart2", "dout_uart2", GATE_TOP_SCLK_PERIC, 2,
			CLK_IGNORE_UNUSED, 0),
	GATE(sclk_uart3, "sclk_uart3", "dout_uart3", GATE_TOP_SCLK_PERIC, 3,
			CLK_IGNORE_UNUSED, 0),
	/*spdif*/
	GATE(pclk_spdif, "pclk_spdif", "aclk66_peric", GATE_BUS_PERIC,
						29, CLK_IGNORE_UNUSED, 0),
	GATE(sclk_spdif, "sclk_spdif", "mout_spdif", GATE_TOP_SCLK_PERIC,
	...
	GATE(chipid, "chipid", "aclk66_psgen", GATE_IP_PERIS,
	...
	GATE(smmu_gscl1, "smmu_gscl1", "mout_user_aclk300_gscl",
							GATE_IP_GSCL1, 7, 0, 0),
	GATE(gscl_wa, "gscl_wa", "mout_user_aclk333_432_gscl",
	...
	GATE(gscl0, "gscl0", "mout_user_aclk300_gscl", GATE_IP_GSCL0, 0, 0, 0),
	GATE(gscl1, "gscl1", "mout_user_aclk300_gscl", GATE_IP_GSCL0, 1, 0, 0),
	GATE(clk_3aa, "clk_3aa", "aclk333_432_gscl", GATE_IP_GSCL0, 4, 0, 0),

	GATE(fimd1, "fimd1", "mout_user_aclk300_disp1", GATE_IP_DISP1, 0, 0, 0),
	...
	GATE(rotator, "rotator", "mout_user_aclk266", GATE_IP_GEN, 1, 0, 0),
	GATE(jpeg, "jpeg", "aclk300_jpeg", GATE_IP_GEN, 2, 0, 0),
	GATE(jpeg2, "jpeg2", "aclk300_jpeg", GATE_IP_GEN, 3, 0, 0),
	GATE(mdma1, "mdma1", "mout_user_aclk266", GATE_IP_GEN, 4, 0, 0),
