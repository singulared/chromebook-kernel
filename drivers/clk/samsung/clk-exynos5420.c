...
enum exynos5420_clks {
	...
	aclk166 = 430, mixer,
	aclk266 = 440, aclk_rotator, mdma1, smmu_rotator, smmu_mdma1,
	...
	pclk_top_rtc, smmu_jpeg2, pclk_rotator,
...
struct samsung_gate_clock exynos5420_gate_clks[] __initdata = {
	...
	/* MMC */
	GATE(aclk_mmc0, "aclk_mmc0", "aclk200_fsys2", GATE_BUS_FSYS0, 12,
							CLK_IGNORE_UNUSED, 0),
	GATE(aclk_mmc1, "aclk_mmc1", "aclk200_fsys2", GATE_BUS_FSYS0, 13,
							CLK_IGNORE_UNUSED, 0),
	GATE(aclk_mmc2, "aclk_mmc2", "aclk200_fsys2", GATE_BUS_FSYS0, 14,
							CLK_IGNORE_UNUSED, 0),
