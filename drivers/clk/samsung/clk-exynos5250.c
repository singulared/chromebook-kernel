...
enum exynos5250_clks {
	...
	mout_aclk300_gscl_sub, mout_aclk333_sub,
...
PNAME(mout_aclk400_g3d_p)	= { "mout_aclk400_g3d_mid", "sclk_gpll" };
PNAME(mout_aclk200_disp1_sub_p) = { "fin_pll", "div_aclk200" };
...
PNAME(mout_aclk300_disp1_sub_p)	= { "fin_pll", "div_aclk300_disp1" };
...
struct samsung_mux_clock exynos5250_mux_clks[] __initdata = {
	...
	MUX(mout_aclk333_sub, "mout_aclk333_sub", mout_aclk333_sub_p, SRC_TOP3,
						24, 1),
	...
	MUX(none, "mout_aclk400_g3d", mout_aclk400_g3d_p, SRC_TOP1, 28, 1),
	MUX(none, "mout_aclk200_disp1_sub", mout_aclk200_disp1_sub_p, SRC_TOP3,
						4, 1),
	MUX(none, "mout_aclk300_disp1_mid", mout_aclk200_p, SRC_TOP0, 14, 1),
	MUX(none, "mout_aclk300_disp1_mid1", mout_aclk300_gscl_mid1_p, SRC_TOP1,
						8, 1),
	MUX(none, "mout_aclk300_disp1", mout_aclk300_disp1_p, SRC_TOP0, 15, 1),
	MUX(none, "mout_aclk300_disp1_sub", mout_aclk300_disp1_sub_p, SRC_TOP3,
						6, 1),
...
struct samsung_div_clock exynos5250_div_clks[] __initdata = {
	...
	DIV(none, "div_aclk66_pre", "sclk_mpll_user", DIV_TOP1, 24, 3),
	DIV(none, "div_aclk66", "div_aclk66_pre", DIV_TOP0, 0, 3),
	DIV_A(div_aclk266, "div_aclk266", "sclk_mpll_user", DIV_TOP0, 16, 3,
						"aclk266_d"),
	DIV_A(none, "div_aclk166", "mout_aclk166", DIV_TOP0, 8, 3,
						"aclk166_d"),
	DIV_A(div_aclk333, "div_aclk333", "mout_aclk333", DIV_TOP0, 20, 3,
						"aclk333_d"),
	DIV_A(none, "div_aclk200", "mout_aclk200", DIV_TOP0, 12, 3,
						"aclk200_d"),
	DIV(div_aclk400_g3d, "div_aclk400_g3d", "mout_aclk400_g3d", DIV_TOP0,
						24, 3),
	DIV_A(div_aclk300_gscl, "div_aclk300_gscl", "mout_aclk300_gscl",
					DIV_TOP1, 12, 3, "aclk300_gscl_d"),
	DIV_A(none, "div_aclk300_disp1", "mout_aclk300_disp1", DIV_TOP0, 28, 3,
						"aclk300_disp1_d"),
...
struct samsung_gate_clock exynos5250_gate_clks[] __initdata = {
	...
	GATE(smmu_gscl3, "smmu_gscl3", "mout_aclk266_gscl_sub", GATE_IP_GSCL,
							10, 0, 0),
	GATE(smmu_tv, "smmu_tv", "mout_aclk200_disp1_sub", GATE_IP_DISP1, 9,
							0, 0),
	GATE(smmu_fimd1, "smmu_fimd1", "mout_aclk200_disp1_sub", GATE_IP_DISP1,
							8, 0, 0),
	...
	GATE(sata_phyctrl, "sata_phyctrl", "div_aclk200", GATE_IP_FSYS, 24,
							0, 0),
	...
	GATE_A(chipid, "chipid", "div_aclk66", GATE_IP_PERIS, 0, 0, 0,
	       "chipid_apbif"),

	GATE(sysreg, "sysreg", "div_aclk66",
			GATE_IP_PERIS, 1, CLK_IGNORE_UNUSED, 0),
	GATE(pmu, "pmu", "div_aclk66",
			GATE_IP_PERIS, 2, CLK_IGNORE_UNUSED, 0),
...
void __init exynos5250_clk_init(struct device_node *np)
{
	...
	if (fin_pll_rate == (24 * MHZ)) {
		...
		epll = samsung_clk_register_pll36xx("fout_epll", "fin_pll",
				reg_base + 0x10030, reg_base + 0x10130,
				epll_24mhz_tbl, ARRAY_SIZE(epll_24mhz_tbl));
		gpll = samsung_clk_register_pll35xx("fout_gpll", "fin_pll",
				reg_base + 0x10050, reg_base + 0x10150,
				gpll_24mhz_tbl, ARRAY_SIZE(gpll_24mhz_tbl));
	} else {
		pr_warn("Exynos5250: valid pll rate_table missing for\n"
	...
	if (mout_vpllsrc_rate == (24 * MHZ)) {
		vpll = samsung_clk_register_pll36xx("fout_vpll", "mout_vpllsrc"
			, reg_base + 0x10040, reg_base + 0x10140,
			vpll_24mhz_tbl, ARRAY_SIZE(vpll_24mhz_tbl));
	} else {
		...
		samsung_clk_register_pll36xx("fout_vpll", "mout_vpllsrc",
			reg_base + 0x10040, reg_base + 0x10140, NULL, 0);
	}
