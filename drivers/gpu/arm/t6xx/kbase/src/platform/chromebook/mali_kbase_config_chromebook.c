...
#if (MALI_DVFS_STEP == 7)
	{ 912500, 100,  0,   0, DVFS_TIME_TO_CNT(0), DVFS_TIME_TO_CNT(0)},
	{ 925000, 160,  0,   0, DVFS_TIME_TO_CNT(0), DVFS_TIME_TO_CNT(0)},
	{1025000, 266,  0,  85, DVFS_TIME_TO_CNT(1000), DVFS_TIME_TO_CNT(3000)},
