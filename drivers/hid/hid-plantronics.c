...
static int __init plantronics_init(void)
{
	return hid_register_driver(&plantronics_driver);
}
module_init(plantronics_init);

static void __exit plantronics_exit(void)
{
	hid_unregister_driver(&plantronics_driver);
}
module_exit(plantronics_exit);
